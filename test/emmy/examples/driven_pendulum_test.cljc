...
(deftest as-javascript
  (is (= ["[y01, y02, y03]"
          ...
          (str
           ...
           "  return [1, y03, (p07 * Math.pow(p08, 2) * _09 * Math.cos(p08 * y01) - p06 * _09) / p05];")]
  ...
  (is (= ["[y01, y02, y03]"
          ...
          (str
           ...
           "  return [1, (a * l * m * omega * _08 * _09 + y03) / (_06 * m), (- Math.pow(a, 2) * l * m * Math.pow(omega, 2) * _08 * Math.pow(_09, 2) * _05 - a * omega * y03 * _09 * _05 - g * _06 * m * _08) / l];")]
         (compile-state-fn*
